                    ...
                    {filteredData.length > 0 ? (
                      filteredData.map((item, index) => (
                        ...
                        >
                          ...
                          <td className="p-3 text-center truncate">{item.action}</td>
                        </tr>
                      ))
                    ) : (
                      <tr>
        ...
        <ModalPortal>
          <>
            ...
            <motion.div
              ...
              className="fixed left-1/2 top-1/2 z-[2001] -translate-x-1/2 -translate-y-1/2 w-[95vw] max-w-[1100px] h-full rounded-3xl overflow-hidden shadow-2xl bg-white dark:bg-slate-900"
