...
export default function AvlagiinNasjiltPage() {
  ...
  const exportToExcel = () => {
    ...
    link.href = url;
    link.download = `avlagiin_nasjilt_${new Date().toISOString().split('T')[0]}.csv`;
    ...
    <div className="p-6 print-container bg-[color:var(--surface-bg)] min-h-screen h-full flex flex-col">
      ...
      <div className="print-only mb-6">
        <div className="flex justify-between items-start border-b-2 border-gray-800 pb-4">
          <div>
            <h1 className="text-2xl font-bold uppercase">Авлагийн насжилт тайлан</h1>
        ...
        <div className="mt-6 border p-4 rounded bg-gray-50 flex justify-between items-center">
          <p className="font-semibold text-gray-700">НИЙТ АВЛАГА:</p>
          <p className="text-2xl font-bold text-red-600">{formatNumber(totalAvlaga)} ₮</p>
        </div>
      </div>
