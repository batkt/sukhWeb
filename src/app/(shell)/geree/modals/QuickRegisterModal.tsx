      ...
      <div className="fixed inset-0 z-[12000] flex items-center justify-center">
        ...
        <div className="flex items-center justify-between px-6 pt-5 pb-4 border-b border-[color:var(--surface-border)]">
          <div className="flex items-center gap-3">
            {step > 1 && (
              <button
                onClick={handleBack}
                className="p-1.5 rounded-lg hover:bg-[color:var(--surface-hover)] text-[color:var(--muted-text)] hover:text-[color:var(--panel-text)] transition-colors"
                title="Буцах"
              >
        ...
        {step === 1 && (
          <div className="px-6 py-6">
            <p className="text-sm font-medium text-[color:var(--muted-text)] mb-5 text-center">
          ...
          <div className="flex flex-col h-[400px]">
            ...
            <div className="px-6 pt-4 pb-2">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-[color:var(--surface-hover)] border border-[color:var(--surface-border)] rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-theme/20 focus:border-theme text-[color:var(--panel-text)]"
                />
              </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto px-6 pb-4 space-y-2 no-scrollbar">
              {filteredList.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-12 text-[color:var(--muted-text)] text-sm">
                    ...
                    >
                      <div className="min-w-0 pr-3">
                        ...
                        <div className="flex flex-wrap items-center gap-x-3 mt-1.5 text-xs text-[color:var(--muted-text)]">
                          ...
                          {person.register && (
                            <>
                              <span className="w-1 h-1 rounded-full bg-[color:var(--panel)] shrink-0" />
