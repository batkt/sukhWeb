...
import { useGereeContext } from "@/app/(shell)/geree/GereeContext";
...
export default function EmployeeSettingsPage() {
  ...
  return (
    <div className="w-full max-w-[1800px] mx-auto px-2 space-y-4 h-[calc(100dvh-7rem)] overflow-hidden flex flex-col">
        {/* Header */}
