        ...
        >
          ...
          <div className="px-5 pb-5 rounded-xl flex gap-2 justify-end">
            <button
              type="button"
              onClick={onCancel}
              className="inline-flex items-center justify-center px-5 py-2 rounded-2xl text-xs font-medium transition-all duration-300 bg-[color:var(--panel)] hover:bg-[color:var(--panel)] text-[color:var(--panel-text)]"
            >
              {cancelLabel}
            </button>
            <button
              type="button"
              onClick={onConfirm}
              className={`inline-flex items-center justify-center px-5 py-2 rounded-2xl text-xs font-medium text-white shadow-sm transition-all duration-300 ${confirmVariant === "danger"
